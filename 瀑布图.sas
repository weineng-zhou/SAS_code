...
Input File          : 
Output File         : E:\Project\HX009-II-02\csr\dev\output\figures\F-14-02-01-01.rtf
...
/*			datacolors=(cxFF0000 cx0000FF cx00C2C0 ) datacontrastcolors=( white )*/
			...
			layout overlay/ cycleattrs=true walldisplay = none 
				...
				discreteLegend "BAR"/ titleattrs=(size=10pt) valueattrs=(size=8pt) title="疾病诊断" 
